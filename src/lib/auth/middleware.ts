...
const MOCK_USERS: Record<UserRole, unknown> = {
  super_admin: {
    id: "dev-admin-uuid",
...
const getMockUser = () => (MOCK_USERS[BYPASS_ROLE] || MOCK_USERS.super_admin) as { id: string; email: string; profile: { id: string; role: UserRole; first_name: string; last_name: string; email: string; phone: string; is_active: boolean; created_at: string; updated_at: string; last_login_at: string; } };
