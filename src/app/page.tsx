    ...
    <div className="min-h-screen bg-[#F5F5F5]">
      ...
      <div className="fixed bottom-6 left-6 z-40 flex flex-col gap-3">
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="w-14 h-14 bg-green-600 hover:bg-green-700 text-white rounded-full shadow-lg flex items-center justify-center transition-transform hover:scale-110"
